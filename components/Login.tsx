...
const SUPABASE_CONFIGURED = isSupabaseConfigured;
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Fetch app_users metadata for role/permissions
            ...
            const mapped: User = {
                ...
                password: '',
                fullName: (appUser?.full_name as string) || (authed.user_metadata?.full_name as string) || authed.email || 'User',
