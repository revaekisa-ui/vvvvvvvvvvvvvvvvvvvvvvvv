        ...
        <div className="bg-brand-bg text-brand-text-primary">
            ...
            <header className="py-4 px-6 md:px-12 flex justify-between items-center bg-brand-surface/80 backdrop-blur-sm sticky top-0 z-50 border-b border-brand-border">
                ...
                <div className="space-x-2">
                    <button type="button" onClick={() => window.location.hash = '#/signup'} className="button-secondary px-6 py-2 text-sm">Daftar</button>
            ...
            <section className="text-center py-20 md:py-32 px-6 bg-gradient-to-b from-brand-surface to-brand-bg">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button type="button" onClick={() => window.location.hash = '#/signup'} className="button-primary text-lg w-full sm:w-auto">Mulai Gratis</button>
                    <button type="button" onClick={() => window.location.hash = '#/login'} className="button-secondary text-lg w-full sm:w-auto">Masuk ke Dasbor</button>
                </div>
            </section>
