...
import { Lead, LeadStatus, ContactChannel, Notification, ViewType } from '../types';
...
const SuggestionForm: React.FC<SuggestionFormProps> = ({ setLeads, addNotification }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            addNotification({
                title: 'Saran Baru Diterima',
                message: `Masukan baru dari ${name} telah diterima.`,
                icon: 'lead',
