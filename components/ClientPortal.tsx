                    ...
                    <h3 className="text-lg font-bold portal-text-primary mb-4">Progres Proyek Aktif: {activeProject.projectName}</h3>
                     <div className="flex items-center gap-4">
                        <div className="w-full bg-slate-200 rounded-full h-2.5">
                            <div className="portal-accent-bg h-2.5 rounded-full" style={{width: `${activeProject.progress}%`}}></div>
                        </div>
                        <span className="font-bold portal-accent-text">{activeProject.progress}%</span>
                    </div>
                                            ...
                                            <div className="ml-4">
                                                ...
                                                {isActive && !isConfirmed && (
                                                    <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                                        ...
                                                        <button onClick={() => { if(selectedProject) onConfirm(selectedProject.id, subStatus.name, '')}} className="mt-2 text-sm font-semibold text-white portal-accent-bg hover:bg-opacity-80 px-4 py-2 rounded-lg inline-flex items-center gap-2"><SendIcon className="w-4 h-4" /> Konfirmasi</button>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
